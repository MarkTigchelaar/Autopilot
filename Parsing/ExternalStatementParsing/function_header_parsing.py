...
from Parsing.utils import is_eof_type, is_primitive_type, is_primitive_literal
...
def parse_function_header(driver, is_function_def = True):
    ...
    fn_header_stmt = FunctionHeaderStatement()
...
def enforce_function(function_token):
    if function_token.internal_type != symbols.FUN:
