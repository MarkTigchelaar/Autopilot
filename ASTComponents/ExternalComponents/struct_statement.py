...
class StructStatement:
    def __init__(self):
        ...
        self.interface_references = list()

    def add_interface_value_type_ref(self, actual_interface_reference):
        self.interface_references.append(actual_interface_reference)
...
class StructField:
    ...
    def set_value_type_ref(self, actual_reference):
        self.actual_type_reference = actual_reference

    def get_resolved_type(self):
        return self.actual_type_reference