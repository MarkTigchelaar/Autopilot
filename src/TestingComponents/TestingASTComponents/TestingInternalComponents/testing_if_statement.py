...
class TestingIfStatement:
    ...
    def print_token_types(self, type_list: list) -> None:
        ...
        if self.if_statement.optional_assignment_type:
            ...
            type_list.append(self.if_statement.unwrapped_optional_variable_name.type_symbol)
    ...
    def to_json(self) -> dict:
        return {
            "type" : "if",
            "assignment_type" : token_to_json(self.if_statement.optional_assignment_type),
            "unwrapped_option" : token_to_json(self.if_statement.unwrapped_optional_variable_name),
