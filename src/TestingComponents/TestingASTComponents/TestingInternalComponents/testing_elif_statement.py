...
class TestingElifStatement:
    ...
    def print_literal(self, repr_list: list) -> None:
        ...
        if self.elif_statement.optional_assignment_type:
            ...
            repr_list.append(self.elif_statement.unwrapped_optional_variable_name.literal)
    ...
    def print_token_types(self, type_list: list) -> None:
        ...
        if self.elif_statement.optional_assignment_type:
            ...
            type_list.append(self.elif_statement.unwrapped_optional_variable_name.type_symbol)
    ...
    def to_json(self) -> dict:
        return {
            "type" : "elif",
            "assignment_type" : token_to_json(self.elif_statement.optional_assignment_type),
            "unwrapped_option" : token_to_json(self.elif_statement.unwrapped_optional_variable_name),
