...
require_relative './ExternalStatementParsers/modparser.rb'
require_relative './ExternalStatementParsers/importparser.rb'
require_relative './ExternalStatementParsers/defineparser.rb'
require_relative './ExternalStatementParsers/enumparser.rb'
require_relative './ExternalStatementParsers/errorparser.rb'
require_relative './ExternalStatementParsers/functionparser.rb'
require_relative './ExternalStatementParsers/interfaceparser.rb'
require_relative './ExternalStatementParsers/structparser.rb'
...
class Parser
    ...
    def _parse()
        ...
        while(!match(EOF))
            ...
            if(type != nil)
                if @analyze_semantics and !has_errors()
    ...
    def peek()
        ...
        puts("---------------------------------------in peek(), token is: #{tok.getText()}")
        return tok
    end
    ...
    def nextToken()
        ...
        puts("------------------------------------in nextToken(), token is: #{tok.getText()}")
        return tok
    end
