...
class TypeResolvedAssignmentStatement(TypeResolvedStatementWithExpression):
    ...
    def resolve_types(self):
        # This handles 'var x = expr' or 'var x: Int = expr'
        # Perform your type inference logic here
        pass